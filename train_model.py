...
from train_src.vgg import VGG
from train_src.train import train
from train_src.eval import eval
from train_src.test import test

def main(model: str = 'VGG19',      # Name of the model to use
         classes: int = 3,          # Number of output dimensions (classes)
         image_size: int = 144,      # Size of the input image (width and height)
